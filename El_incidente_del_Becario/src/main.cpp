...
glm::mat4 matrixModelMainCharacter = glm::mat4(1.0);
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	// main character
	mainCharacterAnimate.loadModel("../models/mainCharacter.fbx");
	mainCharacterAnimate.setShader(&shaderMulLighting);
...
bool processInput(bool continueApplication) {
	...
	if (modelSelected == 0 && glfwGetKey(window, GLFW_KEY_LEFT) == GLFW_PRESS){
		matrixModelMainCharacter = glm::rotate(matrixModelMainCharacter, glm::radians(1.0f), glm::vec3(0, 1, 0));
		animationIndex = 0;
	}else if (modelSelected == 0 && glfwGetKey(window, GLFW_KEY_RIGHT) == GLFW_PRESS){
		matrixModelMainCharacter = glm::rotate(matrixModelMainCharacter, glm::radians(-1.0f), glm::vec3(0, 1, 0));
		animationIndex = 0;
	}if (modelSelected == 0 && glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS){
		matrixModelMainCharacter = glm::translate(matrixModelMainCharacter, glm::vec3(0, 0, 0.02));
		animationIndex = 0;
...
void applicationLoop() {
	...
	while (psi) {
		...
		if(modelSelected == 1){
			axis = glm::axis(glm::quat_cast(matrixModelMainCharacter));
			angleTarget = glm::angle(glm::quat_cast(matrixModelMainCharacter));
			target = matrixModelMainCharacter[3];
		}
...
void prepareDepthScene() {
	...
	mainCharacterAnimate.setShader(&shaderDepth);
}
...
void renderScene(){
	...
	/*********************************************
	*  Render del main character (personaje principal)
	**********************************************/
	glDisable(GL_CULL_FACE);
	matrixModelMainCharacter[3][1] = terrain.getHeightTerrain(matrixModelMainCharacter[3][0], matrixModelMainCharacter[3][2]);
	glm::mat4 matrixModelMainCharacterBody = glm::mat4(matrixModelMainCharacter);
	matrixModelMainCharacterBody = glm::scale(matrixModelMainCharacterBody, glm::vec3(0.021, 0.021, 0.021));
	mainCharacterAnimate.setAnimationIndex(animationIndex);
	mainCharacterAnimate.render(matrixModelMainCharacterBody);
